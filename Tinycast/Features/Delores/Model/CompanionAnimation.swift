...
enum DeloresCompanionAnimation {
    ...
    /// How often the drawn pose changes while walking.
    static let walkFrame: TimeInterval = 1.0 / 9.0
    ...
    /// staircase — the body was elsewhere for a sixth of a second and then it was here. Two
