...
extension SettingsTab {
    var ownedCommands: [CommandID] {
        ...
        // AI Chat and the Quick Actions catalogue are shared Core capabilities, not Surface settings.
        case .aiAndActions: [.aiChat, .fixGrammar, .rewrite, .translate, .summarize]
