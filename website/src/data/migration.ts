...
export const migration = {
  ...
  intro:
    "Delores reads a Raycast export directly. Point it at your .rayconfig file, type the passphrase, and your shortcuts come with you.",
  ...
  requirement: {
    ...
    // The version named here is upstream Tinycast's, not Delores's: Delores forked after that
    // change landed, so it inherits the behaviour but never had a v0.10.5 of its own. Do not
    // restate it as a Delores version.
    body: "Delores reads the .rayconfig that Raycast v2.0 and later write. Raycast v1.x files are not supported — that format was dropped upstream, in Tinycast v0.10.5.",
  },
  steps: [
    {
