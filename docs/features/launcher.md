...
Nine panes own commands today — AI, Quick Actions, File Search, Notes, Navigation, Window Management,
Clipboard, Emoji and Quicklinks. What is left in Settings › Commands is the set no feature switch
governs: Calculator History, the three backup commands, Check for Updates, Settings, About, Support
and Quit.
