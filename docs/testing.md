...
| `tool-runner-test` | `Platform/ToolRunner.swift` — draining, merged stderr, exit statuses and the tail, output past the pipe buffer, a missing executable, and both waits a tool can refuse to end |
